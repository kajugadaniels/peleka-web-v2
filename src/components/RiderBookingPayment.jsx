...
/**
 * RiderBookingPayment Component
 * Handles Flutterwave payments for rider bookings.
 *
 * Props:
 ...
 */
const RiderBookingPayment = ({ amount, tx_ref, customer, onSuccess, onFailure }) => {
    ...
    const fwConfig = {
        ...paymentConfig,
        text: 'Send Rider Booking', // Fixed button text
...
export default RiderBookingPayment;

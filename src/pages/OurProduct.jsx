                                            ...
                                            <div className="get-started-wrap flex">
                                                <div className="wrap-content">
                                                    <h2 className="font-cardo fw-7 wow fadeInUp" data-wow-delay="0s">
                                                        You've worked with
                                                        the rest;<br />Work with the best
                                                    </h2>
                                                    <p className="fs-15 wow fadeInUp" data-wow-delay="0.1s">
                                                        We pray that you come to us and we will show you the meaning of efficiency in the line of duty.
                                                    </p>
                                                    <a className="tf-btn wow fadeInUp" data-wow-delay="0.2s" href="#">
                                                        Request service <i className="icon-arrow-top-right"></i>
                                                    </a>
                                                </div>
                                                    ...
                                                    <div className="tags-list style2">
                                                        <ul className="tag-list">
                                                            <li className="tag-list-item wow fadeInUp" data-wow-delay="0.3s">
                                                                <a className="font-outfit" href="#">Fast Couriers</a>
                                                            </li>
                                                            <li className="tag-list-item wow fadeInUp" data-wow-delay="0.4s">
                                                                <a className="font-outfit" href="#">City tours</a>
                                                            </li>
                                                            <li className="tag-list-item wow fadeInUp" data-wow-delay="0.5s">
                                                                <a className="font-outfit" href="#">Tourism assist</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
